...
print(datos)          
data = datos.drop('famhist', axis=1)
data1 = data.drop('chd', axis=1)
print(data1)
tabla1 = pd.DataFrame(data=data1)
acp = ACP(data1)
...
acp1 = ACP(datos_dummy,n_componentes=5)
#b.1
acp1.plot_plano_principal()
#b.2
acp1.plot_circulo()
#b.3
acp1.plot_sobreposicion()
